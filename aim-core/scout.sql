...
-- hierarchy
insert into hierarchy values (null,'Nasionaly',null,null,'1');
...
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 1, '', 'Miana-mandady', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 1, '', 'Vaky Maso Tokana', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 1, '', 'Vaky Maso Roa', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 2, '', 'Mpiomana', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 2, '', 'Mpikatroka', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 2, '', 'Menavazana', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 3, '', 'Mpamakilay', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 4, '', 'Mpiana-dalana', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 4, '', 'Mpiray lalana', null);
insert into section_steps (id, section_id, level, name, deleted_at) values (null, 4, '', 'Mpiandalana', null);

-- activity_field
insert into activity_field values(null,'I','Madagasikara',null,'Madagasikara',null,1,null);

insert into activity_field values(null,'II','Antananarivo',1,'Antananarivo','diosezy',2,null);
insert into activity_field values(null,'III','Toamasina',1,'Toamasina','diosezy',2,null);
insert into activity_field values(null,'IV','Moramanga', 1,'Moramanga','diosezy',2,null);
insert into activity_field values(null,'V','Toliara',1,'Toliara','diosezy',2,null);
insert into activity_field values(null,'VI','Miarinarivo',1,'Miarinarivo','diosezy',2,null);
insert into activity_field values(null,'VII','Ihosy',1,'Ihosy','diosezy',2,null);
insert into activity_field values(null,'VIII','Mahajanga',1,'Mahajanga','diosezy',2,null);

insert into activity_field values(null,'IX','Analamanga',2,'Analamanga','faritra',3,null);
insert into activity_field values(null,'X','Atsimon-drano',2,'Atsimon-drano','faritra',3,null);
insert into activity_field values(null,'XI','Avaradrano',2,'Avaradrano','faritra',3,null);
insert into activity_field values(null,'XII','Toamasina I',3,'Toamasina I','faritra',3,null);
insert into activity_field values(null,'XIII','Toamasina II',3,'Toamasina II','faritra',3,null);
insert into activity_field values(null,'XIV','Toamasina III',3,'Toamasina III','faritra',3,null);

insert into activity_field values(null,'XV','St Michel',9,'Amparibe','Fianarana',4,null);
insert into activity_field values(null,'XVI','St Joseph',9,'Mahamasina','Fiangonana',4,null);
insert into activity_field values(null,'XVII','Providence',9,'Amparibe','Fianarana',4,null);
insert into activity_field values(null,'XVIII','EKAR Ambohimamory',9,'Ambohimamory','Fiangonana',4,null);
insert into activity_field values(null,'XIX','St Michel Itaosy',9,'Itaosy','Fianarana',4,null);

insert into activity_field values(null,'XX','Tanjombato',2,'Tanjombato','faritra',3,null);
insert into activity_field values(null,'XXI','Manjakandriana',2,'Manjakandriana','faritra',3,null);
insert into activity_field values(null,'XXII','Ambohitrimanjaka',2,'Ambohitrimanjaka','faritra',3,null);
insert into activity_field values(null,'XXIII','Imerinafovoany',2,'Imerinafovoany','faritra',3,null);
insert into activity_field values(null,'XXIV','Namehana',2,'Namehana','faritra',3,null);
insert into activity_field values(null,'XXV','Itaosy',2,'Itaosy','faritra',3,null);
...
insert into process_type (id, name, note, deleted_at) values (null, 'Mialoha', '', null); 
insert into process_type (id, name, note, deleted_at) values (null, 'Mandritra', '', null); 
insert into process_type (id, name, note, deleted_at) values (null, 'Aorina', '', null);


insert into education_field (id, name, note, deleted_at) values (null, 'Saina', '', null);
insert into education_field (id, name, note, deleted_at) values (null, 'Toetra', '', null);
insert into education_field (id, name, note, deleted_at) values (null, "Fifandraisana amin'ny hafa", '', null);
insert into education_field (id, name, note, deleted_at) values (null, 'Fo', '', null);
insert into education_field (id, name, note, deleted_at) values (null, 'Fanahy', '', null);
insert into education_field (id, name, note, deleted_at) values (null, 'Vatana', '', null);

insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, 'Tsy mihambatra fa mavitrika tsara rehefa manao hiaka rodobe na famoriana', null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, 'Mahay mitondra hafatra', null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, 'Mahay mampiditra kofehy amin’ny fanjaitra sy manao vikavika', null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay mamatotra folara, kiraro, manao vona tsotra sy ganse ary baraingo (tête d'alouette)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahafantatra ny toerana lehibe ao an-tanana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahafantatra ny trano fonenany", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahalala ny lafin-tany efatra", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahalala ny fiposahan’ny masoandro sy ny filentehany", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahalala tsongo dia 5", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay Arahaba lovitao", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay Baikon’ny lovitao", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay Fanomezan-toky lovitao", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay Lalàna sy fitsipiky ny lovitao", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahalala ny anaran’ny ray aman-dreny", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahalala ny adiresin’ny ray aman-dreny sy ny faritra fonenana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahafantatra ny tantaran’i Mowgli (Fizarana 1 – 2)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay ny « Izahay no lovitao » sy ny « Manodidina izahay »", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay ny hiram-pirenena andininy telo", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay tarehi-marika romanina (1 ka hatramin’ny 10)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 1, "Mahay ny anaran’ny Filoham-pirenena Malagasy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Mahalala fomba", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Tonga ara-potoana lalandava", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Tsy tapaka amin’ny fihetsiketsehana rehetra", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Madio fiteny, firesaka", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Miezaka manao asa soa momba ny tenany irery", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Manao fanamiana mijijy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Mijoro mifanatrika ary mahay mitonona sy mahafantatra ny anarany, ny taonany", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 2, "Mahatadidy ny daty nahaterahana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 3, "Miezaka manao asa soa isan’andro", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 3, "Mahalala ny anaran’ny Rektora sy ny RAP (na ZAP) ary ireo mpanabe ao amin’ny kolejy (Directrice, Préfète)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 4, "Mahay maneho ny heviny eo amin’ny vato fihaonana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 5, "Mahay Vavaky ny lovitao", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 5, "Mahay ny Rainay, Arahaba ry Maria, Voninahitra, Fanenenana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 5, "Mahay ny vavaka fohy fanao aloha sy aorinan’ny sakafo, alohan’ny hatory sy rehefa mifoha", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 5, "Mahafantatra ny fizaran’ny lamesa", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 5, "Famantarana ny Hazo fijaliana, ny heviny, fotoana fanaovana azy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 5, "Mahay ny tantaran’i Md François d’Assise amin’ny ambangovangony", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 6, "Midio mandrakariva amin’ny savony", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 6, "Mitandrina mandrakariva ny fahadiovana amin’ny toerana rehetra aleha ", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 1, 6, "Mahavita dia tongotra 5 km", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mitsidika trano fanaovana tao-zavatra na toerana manan-tantara iray", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahavita asa-tanana maro", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay manjaitra ny rovitra sy manaraka sary", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay ny tsongo dia rehetra ka manara-dalana mitondra ny enina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay semaforo P...Z", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay ny fampiasana ireo vona lovitao : tisserand, cabestan.", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay mamantatra morsa, indrindra ny tandremo ka mampangina ny enina misy azy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay mampianatra hira sy manentana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahalala vola", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahatadidy ny daty nahaterahany sy ny taonan’ny ray aman-dreny (daty, volana, taona) sy ny laharana an-tarobian’ny ray aman-dreny", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay ny hiran’ny velirano", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahafantatra ny tantaran’i Mowgli hatramin’ny farany ka afaka mitantara amin’ny enina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay ny anarany sy ny toeran’ny marika fampiasan’ny lovitao", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 1, "Mahay manao ny sarin’i Madagasikara ka mampiseho ireo faritra 6, 22 régions, fiteny, foko, renirano", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 2, "Mikajy ny asa rehetra ataony", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 2, "Mitarika asa soa iarahan’ny enina mamolavola mialoha tamin’ny mpiandraikitra", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 2, "Manara-baovao (actualités)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 3, "Mitarika ny namana hanao asa soa", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 3, "Mitarika ny namana hanao ny tsara hatrany", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 3, "Manampy ny namany raha tojo fahasahiranana amin’izay atao rehetra", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 3, "Manampy ny vaovao amin’ny fanomezan-toky", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 4, "Mampianatra lovetisma amin'ny enina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mahay manao vavaka tora-po", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mahay ny didin’ny Eglizy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mahafantatra ny Eveka eo amin’ny faritany misy azy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mahafantatra ny Apostoly 12, ny isan’ny Avanjely", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mahafantatra ny anaran’ny Papa Ray masina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mahay ny vavaky ny antily", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mikaofesy matetika ary manazava ny antony", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Manampy ny cheftaine mampita ny tantaran’i Md Françios d’Assise amin’ny andia.", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 5, "Mianatra Sakramentan'ny Eokaristia", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 6, "Mahalala ny didy folon’ny fahasalamana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 6, "Mahay mampilaza ny mpiandraikitra raha misy voina na loza", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 6, "Mahalala raokandro", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 6, "Mahay manazava eo imason’ny andia, ny ankizy hafa mitovy taona amin’ny tena, ny asan’ny rivotra, masoandro, torimaso, sakafo, ", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 6, "Milofo amin’ny fanatanjahan-tena iray (talenta)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 3, 6, "Mahay manomana sy mampiasa trousse de secours sy afaka mampiseho ny vonjy aina tsotra", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahafantatra ny kojakoja entina rehefa milasy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay manara-dalana mitondra ny enina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay manjaitra bokotra sy manao vikavika ary nœud de couture", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay manao sary", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny tsongo dia rehetra ka manara-dalana mitondra ny enina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mianatra asa-tanana irery hiarahana midinika amin’ny mpiandraikitra", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay semaforo A...O", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay vona : mpanjono (pêcheur), fisaka (plat), omby, en huit, capucin", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay mihira irery", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay mampilalao ny enina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mikolokolo sy mampirina ny fitaovam-pianarana, fitafiana, fitaovana any an-trano", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay mamantatra morsa, indrindra ny tandremo ka mampangina ny tenany", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny atsimo sy ny avaratra eo amin’ny toerana misy azy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahalala ny sainam-pirenena sy ny tantarany ary afaka manazava Mahalala ny sainam-pirenena sy ny tantarany ary afaka manazava", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahalala daty malaza vitsivitsy momba ny firenena", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny fahalalam-pomba malagasy ", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahalala ny fizaran-taona malagasy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny sidiky ny Antily", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny anaran’ny olona namorona ny skotisma sy ny lovitisma", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny rafitra tsotsotra ao amin’ny fikambanana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay tantara Atiala (Fizarana 3 – 4)", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay mampiasa famataran’andro", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny faritany 6", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahafantatra ny mpitondra nifadimby ", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay ny laharan’ny fivondronana, sy ny anaran’ny Tonia", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahafantatra morsa ", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 1, "Mahay manangana zoro any an-dasy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 2, "Mitsiky lalandava na misy zavatra mahasosotra aza", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 2, "Manao raharaha ary mahavita ny baiko omena azy mandrakariva", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 2, "Milaza ny antony tsy nivoriana tamin’ny farany ary miera raha tsy ho afaka amin’ny manaraka", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 2, "Mihezaka miaina ireo lalana sy fitsipika ary baiko", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 3, "Mahay mizara", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 3, "Manara-maso sy manitsy ny fanamian’ny namana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 3, "Manampy ny namany mampirina ny entany any an-dasy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 3, "Mandray anjara amin’ny raharaha ao an-trano", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 3, "Mahay mifanerasera amin’ny hafa", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 5, "Manaraka ny fanabeazam-panahy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 5, "Mahay miservy lamesa", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 5, "Mitarika vavaka any am-pivoriana sy any an-dasy", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 5, "Mahalala ny fotoanan’ny fankamasinana amin’ny Sorona Masina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 5, "Mahalala ny antony hamangiana ny Sakramenta Masina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 5, "Mahay ny tantaran’i Md François d’Assise feno", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 6, "Manao fanatanjahan-tena isa-maraina", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 6, "Mahay manadio ny faritra itobiana", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 6, "Mahalala fanafody fanefitry ny tazo, aretin’andoha, sery, kohaka", null);
insert into education_goal (id, section_steps_id, education_field_id, education_goal, deleted_at) values (null, 2, 6, "Mahalala raokandro 5 fitsabona", null);

insert into talent_category (id, name, color, deleted_at) values (null, 'Loko manga', 'Manga', null);
insert into talent_category (id, name, color, deleted_at) values (null, 'Loko mena', 'Mena', null);
insert into talent_category (id, name, color, deleted_at) values (null, 'Loko mavo', 'Mavo', null);
insert into talent_category (id, name, color, deleted_at) values (null, 'Loko maitso', 'Maitso', null);
insert into talent_category (id, name, color, deleted_at) values (null, 'Loko fotsy', 'Fotsy', null);

insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 1, 'Mpitahiry', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 1, 'Mpandinika', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 1, 'Mpampita hafatra', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 1, 'Mpanao hatsikana', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 1, 'Tia mozika', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 1, 'Mpitan-tsoratra', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 2, 'Mpitari-dalana', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 2, 'Mpitondra hafatra', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 2, 'Asa an-trano', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 2, 'Mpamonjy voina', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 3, 'Asa tanana', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 3, 'Mpandrafitra', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 3, 'Mpanjaitra', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 3, 'Mpandrary', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 3, 'Manao zaridaina', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 3, 'Sakaizan’ny biby', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 4, 'Mpilomano', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 4, 'Fanatanjahan-tena', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 4, 'Mahay milalao', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 4, 'Mahay milasy', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 4, 'Mpitaingina Bisikileta', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 5, 'Mianatra katesizy', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 5, 'Mahay Evanjely', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 5, 'Mpiservy lamesa', '', '', null);
insert into talent (id,talent_category_id, name, image, note, deleted_at) values (null, 5, 'Mpanao litorjia', '', '', null);

-- insert into activity_field_section (id, activity_field_id, section_id, deleted_at) values (null, 15, 1, null);
-- insert into activity_field_section (id, activity_field_id, section_id, deleted_at) values (null, 15, 2, null);
-- insert into activity_field_section (id, activity_field_id, section_id, deleted_at) values (null, 15, 3, null);
-- insert into activity_field_section (id, activity_field_id, section_id, deleted_at) values (null, 15, 4, null);
...
create view activity_talent_goal_member as
...
group by ap.title, ap.date, ss.id, ss.section_id, ap.activity_field_id;

-- stat nombre de membre --
create view member_count_by_year as
select year(entry_date) year, count(*) members from member group by year(entry_date);
